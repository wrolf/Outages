...
import net.wrolf.android.common.db.SelectionBuilder;
...
public class FeedProvider extends ContentProvider {
    ...
    /**
     * URI ID for route: /outages
     */
    public static final int ROUTE_ENTRIES = 1;

    /**
     * URI ID for route: /outages/{ID}
     */
    ...
    static {
        sUriMatcher.addURI(AUTHORITY, "outages", ROUTE_ENTRIES);
        sUriMatcher.addURI(AUTHORITY, "outages/*", ROUTE_ENTRIES_ID);
    }
    ...
    /**
     * Determine the mime type for outages returned by a given URI.
     */
    @Override
     ...
     *
     * <p>Currently supports returning all outages (/outages) and individual outages by ID
     * (/outages/{ID}).
     */
    @Override
    ...
    /**
     * Insert a new outage into the database.
     */
    @Override
    ...
    /**
     * Delete an outage by database by URI.
     */
    @Override
